...
resource "google_storage_bucket_object" "inputs" {
  name   = "inputs/" # folder name should end with '/'
  # source = "../data/raw/file.txt"
  content = " "            # content is ignored but should be non-empty
  bucket = google_storage_bucket.bucket.name
}

resource "google_storage_bucket_object" "outputs" {
  name   = "outputs/" # folder name should end with '/'
  content = " "            # content is ignored but should be non-empty
  bucket = google_storage_bucket.bucket.name
}
...
resource "google_storage_bucket_object" "template" {
  name   = "template/" # folder name should end with '/'
  content = " "            # content is ignored but should be non-empty
  bucket = google_storage_bucket.bucket.name
}
